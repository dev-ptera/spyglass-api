...
/** Used to toggle between banano and nano profiles */
...
export const MANUAL_PEER_MONITOR_URLS = useBananoConfig() ? BAN.MANUAL_PEER_MONITOR_URLS : NANO.MANUAL_PEER_MONITOR_URLS;;
...
export const HOST_NODE_NAME =  useBananoConfig() ? BAN.HOST_NODE_NAME : NANO.HOST_NODE_NAME;;
